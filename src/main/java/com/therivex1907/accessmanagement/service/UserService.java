...
public interface UserService {
    ...
    BaseResponse<PageResponse<UserResponse>> getAllUsers(Pageable pageable);
...
//    BaseResponse<UserResponse> getByLastName(String lastName);
    BaseResponse<PageResponse<UserResponse>> searchUsers(UserSearchFilter userSearchFilter, Pageable pageable);
